...
AppSetupInputState::AppSetupInputState(QWidget *parent) : QWidget(parent)
{
    ...
    connect( tb_, SIGNAL(clicked()), this, SLOT(selectState()) );
    setLayout(layout);
    return;
}

void AppSetupInputState::setEnabled(bool b)
{
    tb_->setEnabled(b);
    return;
}

void AppSetupInputState::setText(QString s)
{
    le_->setText(s);
    return;
}

void AppSetupInputState::selectState()
{
